...
Gem::Specification.new do |s|
  ...
  s.bindir = "exe"
  s.date = "2016-05-11"
  s.description = "A lightweight ruby client for the Kami REST API."
  ...
  s.homepage = "https://github.com/jheth/kami"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.5.1"
  s.summary = "A lightweight ruby client for the Kami REST API."
